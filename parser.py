...
class Parser(Lexer):
  ...
  def p_conditional_statement_1(self, t):
    ...
    t[0] = ast.ConditionalStatement(t[3], t[5], ast.EmptyNode())
  ...
  def p_conditional_statement_2(self, t):
    ...
    t[0] = ast.ConditionalStatement(t[3], t[5], t[7])
  ...
  def p_loop_statement_2(self, t):
    ...
    t[0] = ast.For(t[3], t[4], t[5], t[7])

  def p_jump_statement_1(self, t):
    '''jump_statement : RETURN SEMICOLON'''
    t[0] = ast.Return(ast.EmptyNode())
  ...
  def p_variable_simpe_expression_2(self, t):
    ...
    t[0] = ast.ArrayExpression(t[1], t[3])
